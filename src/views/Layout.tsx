...
import Records from '../components/records/records1/Records';
  ...
  return (
    <div>
      <div className="grid sm:grid-rows-desktop sm:grid-cols-desktop grid-cols-phone grid-rows-mobile sm:gap-x-5 z-screen sm:h-screen sm:p-5">
        ...
        <div className="mt-5 sm:m-0 sm:col-start-3 sm:row-start-2 sm:row-end-3 row-start-3 col-start-1 bg-black rounded-xl shadow-mainShadow mx-4 sm:mx-0 overflow-y-auto">
          <Records />
        </div>
