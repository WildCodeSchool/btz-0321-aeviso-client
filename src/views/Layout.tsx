...
function Layout(): JSX.Element {
  ...
  const [sideBarClass, setSideBarClass] = useState(
    'sm:flex flex-col border-2 border-blue bg-white dark:bg-black w-full h-full rounded-lg text-black dark:text-white font-roboto justify-between shadow-mainShadow invisible sm:visible'
  );
    ...
    <div
      className={
        isDarkMode
          ...
          : 'grid bg-bgdark dark sm:grid-rows-desktop sm:grid-cols-desktop grid-cols-phone grid-rows-mobile sm:gap-x-5  min-h-screen sm:max-h-screen sm:p-5'
      }
    >
