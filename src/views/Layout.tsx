...
function Layout(): JSX.Element {
  ...
  return (
    <>
      {isLoading && <Spinner fixed fullScreen transparent text="Reconnecting you..." />}
      <div className="grid sm:grid-rows-desktop sm:grid-cols-desktop grid-cols-phone grid-rows-mobile sm:gap-x-5  min-h-screen sm:max-h-screen sm:p-5 bg-whiteGray dark:bg-mainBg">
        ...
        <div className="h-full pb-10 sm:pb-0 sm:row-start-1 sm:row-end-4 row-start-2 row-end-4 col-start-1 sm:col-start-2">
          <Switch>
            <Routes />
          </Switch>
        </div>
