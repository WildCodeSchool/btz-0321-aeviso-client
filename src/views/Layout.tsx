...
function Layout(): JSX.Element {
  ...
  const [sideBarClass, setSideBarClass] = useState(
    'flex flex-col bg-black w-3/12 fixed h-screen text-white font-roboto justify-between'
  );
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-end">
        ...
        <div className="grid sm:grid-rows-desktop sm:grid-cols-desktop grid-cols-phone grid-rows-mobile sm:gap-x-5  h-screen w-full sm:w-9/12 pb-5 sm:pl-5 px-3 overflow-y-auto">
