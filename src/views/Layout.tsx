...
function Layout(): JSX.Element {
  ...
  return (
    <div className="grid sm:grid-rows-desktop sm:grid-cols-desktop grid-cols-phone grid-rows-mobile sm:gap-x-5  min-h-screen sm:max-h-screen  sm:p-5">
      <div className="sm:col-start-1 sm:col-end-2 sm:row-start-2 sm:row-end-4 row-start-1 row-end-6 col-start-1">
        {isSidebarVisible ? <SideBar setIsSidebarVisible={setIsSidebarVisible} sideBarClass={sideBarClass} /> : ''}
      </div>
      <div className="sm:row-start-1 sm:row-end-2 sm:col-start-1 sm:mb-2 sm:col-end-3 row-start-1 row-end-2 col-start-1 items-end  text-white font-roboto sm:flex justify-between mx-4 mt-5 sm:m-0">
