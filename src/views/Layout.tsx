...
function Layout(): JSX.Element {
  ...
  return (
    <div>
      ...
      <div className="sm:col-start-2 sm:row-start-2 sm:row-end-3 row-start-2 row-end-2 col-start-1 bg-black rounded-xl shadow-mainShadow mx-4 sm:mx-0 overflow-y-auto">
        <Companies />
      </div>
