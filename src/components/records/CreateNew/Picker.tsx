...
function Picker({ setDayActive, register }: IPicker): JSX.Element {
  ...
  return (
    <div>
      {data?.length === 0 ? (
        <p className="mx-4 sm:mx-2 mt-5 text-lg">
          {"Vous n'êtes actuellement affilez à aucun projet vous ne pouvez donc pas encore effectuer de rapport"}
        </p>
      ) : (
        <div>
          ...
          <p className="font-bold sm:text-lg mx-4 sm:mx-0 mt-7">
