...
function User(): JSX.Element {
  ...
  return (
    <div className="grid   grid-cols-2 grid-rows-4 gap-5 h-full w-full text-white">
      {user.role === 'ADMIN' ? (
        <div className="sm:row-start-1 sm:col-start-1 sm:row-end-3 sm:col-end-2 col-start-1 border-2 dark:border-componentBorder bg-white dark:bg-component rounded-lg shadow-buttonShadow dark:shadow-mainShadow mx-4 sm:mx-0 overflow-y-auto">
          <AllRecordsUser />
        </div>
      ) : (
      ...
      {user.role === 'ADMIN' ? (
        <div className="sm:row-start-3 sm:col-start-1 sm:row-end-5 sm:col-end-2 col-start-1 border-2 dark:border-componentBorder bg-white dark:bg-component rounded-lg shadow-buttonShadow dark:shadow-mainShadow mx-4 sm:mx-0 overflow-y-auto">
          <ProjectsUser />
        </div>
      ) : (
