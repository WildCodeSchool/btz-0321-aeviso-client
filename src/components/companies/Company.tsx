...
function Company(): JSX.Element {
  ...
  return (
    <div className="grid sm:grid-cols-2  grid-cols-1 grid-rows-7  gap-5 h-full w-full">
      ...
      <div className="text-white sm:col-start-2 sm:col-end-3 sm:row-start-1 sm:row-end-5 row-start-4 row-end-7 h-96 sm:h-full col-start-1 bg-white dark:bg-component rounded-lg shadow-buttonShadow dark:shadow-mainShadow mx-4 sm:mx-0 overflow-y-auto">
        {isCreatForm}
        <CreateCompany
